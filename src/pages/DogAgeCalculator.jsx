...
const DogAgeCalculator = () => {
  ...
  const resultText = useMemo(() => {
    ...
    return [
      ...
      "",
      "Age Result",
      `Dog Age: ${result.years} ${t("common.years")} ${result.months} ${t("common.months")} ${result.days} ${t("common.days")}`,
  ...
  const copyResult = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download =
        "AgeVerseGlobal-Dog-Age-Result.png";
  ...
  const downloadPdf = async () => {
    ...
    try {
      ...
      anchor.download =
        "AgeVerseGlobal-Dog-Age-Calculator-Result.pdf";
    ...
    try {
      ...
      if (
        ...
        await navigator.share({
          title:
            "AgeVerseGlobal — Dog Age Calculator",
          text:
          ...
          {!result ? (
            ...
            >
              ...
              <div className="dog-age-human-result">
                ...
                <small>
                  {t("Approximately")} {" "}
                  {result.humanYears} {t("common.years")} {" "}
                  {result.humanMonths} {t("common.months")}
                </small>
