...
const FdCalculator = () => {
  ...
  const copyResult = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = "AgeVerseGlobal-FD-Result.png";
  ...
  const downloadPdf = async () => {
    ...
    try {
      ...
      const anchor = document.createElement("a");
      anchor.href = url;
      anchor.download = "AgeVerseGlobal-FD-Calculator-Result.pdf";
      document.body.appendChild(anchor);
      anchor.click();
      anchor.remove();
      URL.revokeObjectURL(url);
  ...
  const sharePdf = async () => {
    ...
    try {
      ...
      const file = new File(
        [blob],
        "AgeVerseGlobal-FD-Calculator-Result.pdf",
      ...
      if (
        ...
        await navigator.share({
          title: "AgeVerseGlobal — FD Calculator",
