    ...
    <footer className="footer">
        ...
        <div className="footer-brand">
          <Link className="footer-logo" to="/" aria-label={t("common.app_name")}>
            <img
              ...
              decoding="async"
            />
             <span className="footer-logo-text" data-translation-bridge-skip="true">AgeVerseGlobal</span>
          </Link>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-content">
          <p>© 2026 <strong data-translation-bridge-skip="true">AgeVerseGlobal</strong>. {t("footer.rights")}</p>
