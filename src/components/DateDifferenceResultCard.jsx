...
function DateDifferenceResultCard({
  ...
  const unitWeeks = t("common.weeks");
...
Exact Difference:
${years} ${unitYears}, ${months} ${unitMonths}, ${days} ${unitDays}

{t("common.from_day")}: ${fromWeekday}
{t("common.to_day")}: ${toWeekday}

${t("common.total_years")}: ${totalYears}
${t("common.total_months")}: ${totalMonths}
{t("common.total_weeks")}: ${totalWeeks}
${t("common.total_days")}: ${totalDays}
{t("common.total_hours")}: ${totalHours}
{t("common.total_minutes")}: ${totalMinutes}
{t("common.total_seconds")}: ${totalSeconds}

Generated by AgeVerseGlobal
`.trim();
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title:
            "AgeVerseGlobal - Date Difference Result",
          text: resultText,
        });
      } else {
        await navigator.clipboard.writeText(
  ...
  async function handleDownload() {
    try {
      ...
      link.download =
        "AgeVerseGlobal_Date_Difference_Result.png";
