/* =========================================================
   AgeVerseGlobal — UNIT CONVERTER EXPORT
...
export async function downloadUnitConverterPDF(
  ...
  pdf.save(
    "AgeVerseGlobal-Unit-Converter-Result.pdf"
  );
  ...
  */
  ...
  if (
    ...
    await navigator.share({
      ...
      title:
        "AgeVerseGlobal Unit Converter Result",

      text:
        "Unit conversion result generated by AgeVerseGlobal",
